...
public class FromTktkActivity extends AppCompatActivity implements View.OnClickListener{ //クリック処理つけるから
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Button button1 = (Button) findViewById(R.id.buttonDoyo);
        button1.setOnClickListener(this);

        Button button2 = (Button) findViewById(R.id.buttonNiti);
        button2.setOnClickListener(this);

        Button button3 = (Button) findViewById(R.id.buttonHei);
    ...
    public void onClick(View v){
        ...
        switch (v.getId()) {
            ...
            case R.id.buttonNiti:
                Log.d("UI_PARTS", "日曜ボタンタップ");
                setContentView(R.layout.activity_fromtktk_niti);
                Button button1_1= (Button) findViewById(R.id.buttonDoyo);
                button1_1.setOnClickListener(this);

                Button button1_2 = (Button) findViewById(R.id.buttonNiti);
                button1_2.setOnClickListener(this);

                Button button1_3 = (Button) findViewById(R.id.buttonHei);
            ...
            case R.id.buttonHei:
                ...
                setContentView(R.layout.activity_fromtktk);
                Button button2_1 = (Button) findViewById(R.id.buttonDoyo);
                button2_1.setOnClickListener(this);

                Button button2_2 = (Button) findViewById(R.id.buttonNiti);
                button2_2.setOnClickListener(this);

                Button button2_3 = (Button) findViewById(R.id.buttonHei);
